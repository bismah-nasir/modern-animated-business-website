...
const TestimonialCard = ({ testimonial, index }) => {
    return (
        <motion.article
            ...
            className="glass-card group flex h-full flex-col rounded-3xl border border-white/10 p-6 transition-all duration-300 hover:-translate-y-2 hover:border-primary/30">
            {/* Quote Icon */}
