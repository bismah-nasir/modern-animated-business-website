            ...
            <div
                ...
                {project.featured && (
                    <div className="absolute right-5 top-5 z-20">
                        <span className="flex items-center gap-2 rounded-full border border-white/20 bg-white/10 px-3 py-1.5 text-xs font-semibold text-white backdrop-blur-md">
                            <Star
                                size={12}
                ...
                <div className="absolute inset-0 flex translate-y-6 items-center justify-center bg-slate-900/85 p-6 pt-12 opacity-0 backdrop-blur-md transition-all duration-500 group-hover:translate-y-0 group-hover:opacity-100">
